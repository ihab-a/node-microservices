...
app.post("/", auth, async (req, res) => {
	...
	const { data : book } = await axios.get(microservices.book.route(req.body.book));
	req._user.points = (await axios.get(microservices.user.route(req._user.id))).data.points;
